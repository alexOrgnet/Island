...
public class Rabbit extends Herbivores {
    ...
    public static int max_count_per_cell = 150; //максимальное количество животных в ячейке
    ...
    public Rabbit(String name, int x, int y, boolean atbirth) {
        ...
        this.weight = 2; //вес животного

        Rabbit.total_number += 1;
        ...
        //Rabbit.count_in_cell[this.x][this.y] =  Rabbit.count_in_cell[this.x][this.y] + 1;
    }
    ...
    public void eat() {
        ...
        if (how_much_grass_to_eat > 0) {
            ...
            //System.out.println("Кролик " + this.hashCode() + " пощипал траву в ячейке x = " + this.getX() + ", y = " + this.getY());
    ...
    public Animal reproduce(Animal mom, Animal dad) {
        ...
        Rabbit foal = (Rabbit) Farm.Birth("Кролик", mom, dad);
    ...
    public void remove_if_dead(int x, int y) {
        ...
        Rabbit.total_number = Rabbit.total_number - 1;

        Rabbit.count_in_cell[x][y] = Rabbit.count_in_cell[x][y] - 1;

        //System.out.println("Погиб кролик " + this.hashCode() + " в ячейке x = " + this.x + ", y = " + this.y);
    }
    ...
    public void move() {
        ...
        int step_for_x = Event.rnd(1, Rabbit.speed);
        int step_for_y = Event.rnd(1, Rabbit.speed);


        Rabbit.count_in_cell[this.x][this.y] = Rabbit.count_in_cell[this.x][this.y] - 1; //меняем статистику по количеству животного данного вида в ячейке острова

        this.make_shift(step_for_x, step_for_y);

        Rabbit.count_in_cell[this.x][this.y] = Rabbit.count_in_cell[this.x][this.y] + 1;

        //System.out.println("Кролик "+this.toString()+"  "  + this.hashCode() + " переместилась в другую ячейку: x = " + this.x + ", y = " + this.y);
